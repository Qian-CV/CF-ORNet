...
def main():
    log_json_dir = ['/media/ubuntu/nvidia/wlq/CTF_ORnet/1mmrotate_main/tools/work_dirs/oriented_Rcnn/oriented_rcnn_r101_fpn_10x_vedai_le90_2/20220712_111259.log.json']
    metric = 'mAP'
    # metric = 'accuracy'
