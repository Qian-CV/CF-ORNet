...
from mmrotate.datasets.VEDAI_noOther import VEDAInoOtherDataset
...
def res_concert(testset_img_path, result_file_root, version):
    ...
    mkdir(save_dir)
    # 判断是hrsc还是VEDAI数据集
    if det_results.shape[1] == 22:
        classes = HRSCDataset.HRSC_CLASSES
    else:
        classes = VEDAInoOtherDataset.CLASSES
    # 读取400+图片的编号
...
def res_evaluate(src_txt_path, gt_dir, imagesetfile, data_type=None):
    """
    ...
    if data_type == 'hrsc':
        ...
        annopath = hrsc_eva.osp.join(gt_dir, '{:s}.txt')
        classnames = ['car', 'truck', 'pickup', 'tractor', 'camping-car', 'van']
    classaps = []
    map = 0
...
if __name__ == '__main__':
    ...
    if data_type == 'hrsc':
        ...
        img_dir = '/media/ubuntu/CE425F4D425F3983/datasets/HRSC2016fg/test/Blurring_img/Clouds/'
        # img_dir = '/media/ubuntu/CE425F4D425F3983/datasets/HRSC2016fg/test/Blurring_img/Brightness/'
        # img_dir = '/media/ubuntu/CE425F4D425F3983/datasets/HRSC2016fg/test/Blurring_img/Blurring/'
        # img_dir = '/media/ubuntu/CE425F4D425F3983/datasets/HRSC2016fg/test/Blurring_img/Noise/'
        gt_dir = '/media/ubuntu/nvidia/HRSC2016fg/test/Annotations/'
        imagesetfile = '/media/ubuntu/nvidia/HRSC2016fg/test/test.txt'
    else:
        img_dir = '/media/ubuntu/CE425F4D425F3983/datasets/VEDAI_1024/test/images/'
        gt_dir = '/media/ubuntu/CE425F4D425F3983/datasets/VEDAI_1024/test/labelTxt_noOther/'
        imagesetfile = '/media/ubuntu/CE425F4D425F3983/datasets/VEDAI_1024/test/test2.txt'
    ...
    if convert_mode == '3':
        ...
        map, classaps = res_evaluate(src_txt_path, gt_dir, imagesetfile, data_type=data_type)
    ...
    if convert_mode == '4':
        ...
        src_txt_path = result_file_root + '/wait4cla/'
        # resnet18权重
        # checkpoint = '/media/ubuntu/nvidia/wlq/CTF_ORnet/1mmrotate_main/tools/work_dirs/_paper_ckpt_set_/exp5_2/res18_low_99.3775.pth'
        ...
        # checkpoint = '/media/ubuntu/nvidia/wlq/CTF_ORnet/3mmclassification/tools/work_dirs/1noise_resnet18_hrsc2016/epoch_200.pth' # 模糊权重
        ...
        checkpoint = '/media/ubuntu/nvidia/wlq/CTF_ORnet/3mmclassification/tools/work_dirs/0Clouds_train2_resnet101_hrsc2016/epoch_200.pth'
        config_dir = '/media/ubuntu/nvidia/wlq/CTF_ORnet/3mmclassification/tools/work_dirs/resnet101_hrsc2016/_resnet101_hrsc2016.py'
        # VEDAI的ckt权重
        # checkpoint = '/media/ubuntu/nvidia/wlq/CTF_ORnet/3mmclassification/tools/work_dirs/resnet50_vedai/epoch_680.pth'
        # checkpoint = '/media/ubuntu/nvidia/wlq/CTF_ORnet/3mmclassification/tools/work_dirs/resnet101_vedai_1000e/epoch_40.pth'
        # config_dir = '/media/ubuntu/nvidia/wlq/CTF_ORnet/3mmclassification/tools/work_dirs/resnet50_vedai/_resnet50_vedai.py'
        # config_dir = '/media/ubuntu/nvidia/wlq/CTF_ORnet/3mmclassification/tools/work_dirs/resnet101_vedai_1000e/_resnet101_vedai.py'
        # resnest101权重
        ...
        if len(args.thresh.split()) == 1:
            ...
            map, classaps = res_evaluate(txt_dir, gt_dir, imagesetfile, data_type=data_type)
